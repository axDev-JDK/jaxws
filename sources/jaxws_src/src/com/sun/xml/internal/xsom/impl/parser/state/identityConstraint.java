...
class identityConstraint extends NGCCHandler {
    ...
    public void enterElement(String $__uri, String $__local, String $__qname, Attributes $attrs) throws SAXException {
        ...
        case 3:
            {
                if(($ai = $runtime.getAttributeIndex("","xpath"))>=0) {
                    NGCCHandler h = new xpath(this, super._source, $runtime, 666);
        ...
        case 8:
            {
                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation"))) {
                    NGCCHandler h = new annotation(this, super._source, $runtime, 673, null,AnnotationContext.IDENTITY_CONSTRAINT);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
        ...
        case 17:
            {
                if((($ai = $runtime.getAttributeIndex("","name"))>=0 && (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation")) || ($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("selector"))))) {
                    NGCCHandler h = new foreignAttributes(this, super._source, $runtime, 683, null);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
                    unexpectedEnterElement($__qname);
        ...
        case 6:
            {
                if(($ai = $runtime.getAttributeIndex("","xpath"))>=0) {
                    NGCCHandler h = new xpath(this, super._source, $runtime, 670);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
                    unexpectedEnterElement($__qname);
    ...
    public void text(String $value) throws SAXException {
        ...
        case 12:
            {
                NGCCHandler h = new qname(this, super._source, $runtime, 676);
